...
### Added
- Zoom in/out functionality with Cmd+ and Cmd- keyboard shortcuts
- Zoom level range from 50% to 300% with 10% increments
- Zoom level resets to 100% on file reload
...
[1.7.0]: https://github.com/paulbuckley/mdsee/compare/v1.6.1...v1.7.0
[1.6.1]: https://github.com/paulbuckley/mdsee/compare/v1.6.0...v1.6.1
